                                    ...
                                    <div id="isiFakultas">
                                        ...
                                        <li>
                                            <a
                                                id="jurusan"
                                                class="dropdown-item"
                                                href="../Sistem Informasi/dataSistemInformasi.php">Sistem Informasi</a>
                                        </li>
                                        <li>
                                            <a
                                                id="jurusan"
            ...
            <section id="tampilDataInformatika">
                <div class="container-fluid">
                    <div class="container tampilDataInformatika-content">
                        <div class="row">
                            <h3 class="judulSection">Menampilkan Data Mahasiswa Sains Data</h3>
                        </div>
                        <div class="row">
                        ...
                        <div class="container">
                            <table class="tabelOutput">
                                ...
                                <?php 
                                    ...
                                    if (!isset($_POST["tombolCari"])){
                                        $ambilDataMahasiswa = ambilSeluruhData($idFormSainsData);
                                    }
