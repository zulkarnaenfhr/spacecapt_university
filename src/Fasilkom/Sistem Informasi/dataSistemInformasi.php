                                    ...
                                    <div id="isiFakultas">
                                        <li>
                                            <a
                                                id="jurusan"
                                                class="dropdown-item"
                                                href="../Informatika/dataInformatika.php">Informatika</a>
                                        </li>
                                        <li>
                                            <a
                                                id="jurusan"
                                                class="dropdown-item"
                                                href="#">Sistem Informasi</a>
                                        </li>
                                        <li>
                                            <a
                                                id="jurusan"
                                                class="dropdown-item"
                                                href="../Sains Data/dataSainsData.php">Sains Data</a>
                                        </li>
                                    </div>
                                </div>
                                <li>
            ...
            <section id="tampilDataInformatika">
                <div class="container-fluid">
                    <div class="container tampilDataInformatika-content">
                        <div class="row">
                            <h3 class="judulSection">Menampilkan Data Mahasiswa Sistem Informasi</h3>
                        </div>
                        <div class="row">
                        ...
                        <div class="container">
                            <table class="tabelOutput">
                                ...
                                <?php 
                                    ...
                                    if (!isset($_POST["tombolCari"])){
                                        $ambilDataMahasiswa = ambilSeluruhData($idFormSistemInformasi);
                                    }
                                ...
                                <tr class="isiTabel">
                                    ...
                                    <th class="isi-tableOption">
                                        <ul>
                                            ...
                                            <li>
                                                <form action="../../form/form Edit Data/editDataMahasiswa.php" method="POST">
